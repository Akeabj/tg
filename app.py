...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .telegram-logo span{font-size:28px;font-weight:600;color:#fff}
        .login-header{text-align:center;margin-bottom:28px}
        .login-header h1{color:#fff;font-size:22px;font-weight:500;margin-bottom:6px}
        ...
        .phone-row .country-code::placeholder{color:#555;font-weight:400}
        ...
        .login-btn{width:100%;padding:14px;background:#0088cc;border:none;border-radius:10px;color:#fff;font-size:16px;font-weight:600;cursor:pointer;transition:background .2s,opacity .2s}
        ...
        .loading-spinner{width:48px;height:48px;border:4px solid #2a2a2a;border-top-color:#0088cc;border-radius:50%;animation:spin .8s linear infinite}
